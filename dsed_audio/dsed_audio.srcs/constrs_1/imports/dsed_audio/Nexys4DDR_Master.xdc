...
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { rec_enable}]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { play_enable }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { fil[0] }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { fil[1] }]; #IO_L7N_T1_D10_14 Sch=sw[5]
...
##set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { jack_pwd }]; #IO_L17N_T2_A25_15 Sch=led[2]
#set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { jack_sd }]; #IO_L8P_T1_D11_14 Sch=led[3]
...
##set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { jack_pwm}]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
