...
set rc [catch {
  ...
  add_files -quiet C:/Users/dsed/DSED_6/Digital_Electronic_Design/dsed_audio/dsed_audio.runs/synth_1/controller.dcp
...
set rc [catch {
  ...
  catch {file copy -force debug_nets.ltx controller.ltx}
