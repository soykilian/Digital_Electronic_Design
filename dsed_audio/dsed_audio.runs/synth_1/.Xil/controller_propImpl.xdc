...
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { jack_pwm }]; #IO_L24P_T3_RS1_15 Sch=led[1]set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { jack?pwd }]; #IO_L17N_T2_A25_15 Sch=led[2]
