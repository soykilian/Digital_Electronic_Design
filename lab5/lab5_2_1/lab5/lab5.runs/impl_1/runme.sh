...
HD_PWD='E:/DSED/DSED_Group6/lab4_2_1/lab5/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log one_second_pulse.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source one_second_pulse.tcl -notrace
