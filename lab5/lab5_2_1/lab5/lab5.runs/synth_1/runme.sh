...
HD_PWD='E:/DSED/DSED_Group6/lab4_2_1/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log one_second_pulse.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source one_second_pulse.tcl
