...
#
# Generated by Vivado on Wed Oct 20 13:08:22 +0200 2021
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot clk_5MHz xil_defaultlib.clk_5MHz -log elaborate.log
}
