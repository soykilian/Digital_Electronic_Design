...
#
# Generated by Vivado on Fri Oct 22 20:00:14 +0200 2021
...
# Script info
echo -e "clk_5MHz.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_5MHz xil_defaultlib.clk_5MHz xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim clk_5MHz -key {Behavioral:sim_1:Functional:clk_5MHz} -tclbatch cmd.tcl -log simulate.log
}
