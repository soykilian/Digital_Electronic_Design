...
#
# Generated by export_simulation on Thu Oct 28 10:26:16 +0200 2021
#
################################################################################
...
switch to the './eight_bit_counter.sh' script.

./eight_bit_counter.sh -reset_run
...
./eight_bit_counter.sh -noclean_files

For more information on the script, please type './eight_bit_counter.sh -help'.
