...
HD_PWD='E:/DSED/DSED_Group6/lab3_3_1/lab3_3_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_mult.tcl
