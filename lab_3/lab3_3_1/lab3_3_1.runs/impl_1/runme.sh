...
HD_PWD='E:/DSED/DSED_Group6/lab3_3_1/lab3_3_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom_mult.tcl -notrace
